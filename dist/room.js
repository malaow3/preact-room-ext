(() => {
  // node_modules/.pnpm/preact@10.26.7/node_modules/preact/dist/preact.module.js
  var n;
  var l;
  var u;
  var t;
  ...
  function O(n2, u2, t2, i2, r2, o2, e2, f2, c2, s2) {
    ...
    n: if ("function" == typeof j2) try {
      if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a2 = j2.contextType) && i2[a2.__c], M2 = a2 ? C2 ? C2.props.value : a2.__ : i2, t2.__c ? m2 = (h2 = u2.__c = t2.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D), C2 && C2.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), y2 = h2.props, v2 = h2.state, h2.__v = u2, p2) S2 && null == j2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
      else {
        if (S2 && null == j2.getDerivedStateFromProps && b !== y2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(b, M2), !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(b, h2.__s, M2) || u2.__v == t2.__v) {
  ...
  // src/room.jsx
  var ExampleVanillaJS = class extends x {
    ...
    render() {
      return /* @__PURE__ */ _("div", { class: "mainmessage" }, /* @__PURE__ */ _("p", null, "Hello World!"));
    }
  };
  var ExampleVanillaJSPanel = class {
  ...
  var result = window.PS.addRoomType(ExampleVanillaJSPanel);
